...
public class BlockGroup {
    ...
    private double numHousingUnits;
    private double numVacantUnits;
    private double numOccupiedUnits;
    ...
    private double initNumWhite = 0.0;
    private double initNumBlack = 0.0;
    private double initNumAsian = 0.0;
    private double initNumHispanic = 0.0;
    
    private double totalIncome;
    
    private int numBlocks = 0;
    private double sampleProportion = .1;
    private int [] raceIncomeList;
    private ArrayList blockList = new ArrayList();
    private CensusTract censusTract;
    private double ownerVacancyRate;
    private double renterVacancyRate;
...
//        int numAgents = 0;
    ...
    */
     ...
     */
    public void setBlockGroupNum(int groupNum) {
        this.blockGroupNum = blockGroupNum;
    }
     ...
     */
    public void setRaceIncomeList(String [] raceIncomeList) {
     ...
     * @param raceIncomeList The raceIncomeList to set.
     */
    public void setRaceIncomeList(int [] raceIncomeList) {
     ...
     */
    public double getNumVacantUnits() {
        return numVacantUnits;
    }
    /**
     * @param numVacantUnits The numVacantUnits to set.
     */
    public void setNumVacantUnits(double numVacantUnits) {
        this.numVacantUnits = convertRawData(numVacantUnits);
    }
    
    public int convertRawData(int data) {
        //MirarUtils.show();
    ...
    public int convertRawData(double data) {
       return MirarUtils.probabilisticInterpolation(data*MirarUtils.OWNER_DATA_SAMPLE);//censusUnitHandler.getSampleProportion());
    }
    public CensusTract getCensusTract() {
        return censusTract;
    }
    public void setCensusTract(CensusTract censusTract) {
        this.censusTract = censusTract;
    }
    ...
    public double getNumTotalPeople() {
    ...
    public void initializeNumWhite(double num) {
        initNumWhite = num;
    }
   
    public void initializeNumBlack(double num) {
        initNumBlack = num;
    }
    
    public void initializeNumHispanic(double num) {
        initNumHispanic = num;
    }
    
    public void initializeNumAsian(double num) {
        initNumAsian = num;
    }
